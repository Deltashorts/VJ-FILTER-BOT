...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/Team_HDR/5")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001959981512'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5009486853').split()]
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Team_HDR/5')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RequestGroupTamil') # Support Chat Link Without https:// or @
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Team_HDR/5')
